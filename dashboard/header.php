            ...
            <div class="sidebar-nav">
                <div class="nav-canvas">
                    ...
                    <ul class="nav nav-pills nav-stacked main-menu">
                        ...
                        <li><a class="ajax-link" href="view-stocks.php"><i class="glyphicon glyphicon-eye-open"></i><span> View Stocks </span></a>
                        </li>
                        <li><a class="ajax-link" href="manage-user.php"><i
                                    class="glyphicon glyphicon-edit"></i><span> Manage Users</span></a></li>
                        <li><a class="ajax-link" href="manage-products.php"><i class="glyphicon glyphicon-list-alt"></i><span>Manage Products</span></a>
                        </li>
                        ...
                        <li><a href="index.php?logout"><i class="glyphicon glyphicon-lock"></i><span>Log Out</span></a>
                        </li>
                    </ul>
